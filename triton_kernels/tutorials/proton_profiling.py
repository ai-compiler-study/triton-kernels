...
# %%
MATMUL_CONFIGS = [
    gen_config(block_m=128, block_n=256, block_k=64, stages=3, warps=8),
    ...
    gen_config(block_m=32, block_n=64, block_k=32, stages=5, warps=2),
]
